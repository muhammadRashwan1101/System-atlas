  ...
  return (
    <div className="w-full grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
      ...
      <div className="bg-[#0e1017] border border-slate-800/80 rounded-xl p-5 flex flex-col justify-between h-28 shadow-lg">
        <span className="text-[11px] uppercase font-semibold text-slate-400 font-(family-name:--labels) tracking-wider">
          COMPONENTS
        </span>
        <span className="text-3xl font-bold text-white tracking-tight font-(family-name:--labels)">
          {componentsCount}
        </span>
      </div>
      ...
      <div className="bg-[#0e1017] border border-slate-800/80 rounded-xl p-5 flex flex-col justify-between h-28 shadow-lg">
        ...
        <span className="text-3xl font-bold text-emerald-400 tracking-tight font-(family-name:--labels)">
          {docsCoverage}
        </span>
      </div>
