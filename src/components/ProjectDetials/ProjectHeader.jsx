...
export default function ProjectHeader({ project }) {
  ...
  return (
    <div className="w-full space-y-5 text-slate-300">
      <div className="bg-[#0e1017] border border-slate-800/80 rounded-2xl p-8 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 shadow-2xl w-full">
        <div className="space-y-4 flex-1 w-full">
          <div className="flex items-center gap-3.5 flex-wrap font-(family-name:--labels)">
            <h1 className="text-3xl font-bold text-white tracking-tight font-(family-name:--headers)">{name}</h1>
          ...
          <p className="text-slate-400 text-xs sm:text-sm leading-relaxed w-full font-(family-name:--body-font)">
            {description}
          </p>

          <div className="flex items-center gap-8 text-xs text-slate-400 pt-1.5 flex-wrap font-(family-name:--labels)">
            <div className="flex items-center gap-2">
              <span className="text-slate-400 uppercase tracking-wider font-semibold">TECH LEAD:</span>
              <span className="text-slate-200 font-medium flex items-center gap-1.5 font-(family-name:--body-font)">
        ...
        <div className="flex items-center gap-3 self-start lg:self-auto shrink-0 font-(family-name:--labels)">
          <button
            type="button"
            onClick={() => alert("Edit project details")}
            className="flex items-center gap-2 px-4 py-2.5 bg-[#161922] hover:bg-slate-800 border border-slate-700/60 rounded-xl text-xs font-semibold uppercase tracking-wider text-slate-300 transition-colors cursor-pointer shadow-md"
          >
            <svg className="w-4 h-4 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 bg-[#f87171] hover:bg-rose-500 text-slate-950 rounded-xl text-xs font-bold uppercase tracking-wider transition-colors shadow-lg shadow-rose-500/20 cursor-pointer"
          >
