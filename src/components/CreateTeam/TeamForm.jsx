...
export default function TeamForm({ formRef, onInputChange, onFinalSubmit }) {
  const {
    register,
    handleSubmit,
    formState: { errors },
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4 w-full">
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="teamName" className="text-slate-400 font-mono text-[11px] tracking-wider uppercase">
              Team Name
            </label>
            <input
              type="text"
              ...
              {...register("teamName", {
                ...
                onChange: (e) => onInputChange && onInputChange("teamName", e.target.value),
              })}
          ...
          {/* Team Code */}
          <div className="flex flex-col gap-2">
            <label htmlFor="teamCode" className="text-slate-400 font-mono text-[11px] tracking-wider uppercase">
              Team Code (MONO)
            </label>
            <input
              type="text"
              ...
              {...register("teamCode", {
                ...
                onChange: (e) => onInputChange && onInputChange("teamCode", e.target.value),
              })}
            ...
            />
            {errors.teamCode && <p className="text-red-500 text-xs">{errors.teamCode.message}</p>}
          </div>
        </div>

        {/* Description */}
        <div className="flex flex-col gap-2 w-full mt-2">
          <label htmlFor="description" className="text-slate-400 font-mono text-[11px] tracking-wider uppercase">
            Description
          </label>
          <textarea
            id="description"
