    ...
    <>
       <div className="bg-[#1E1F23] p-6 border border-[#2D303A] rounded-lg">
              <h5 className="uppercase flex items-center gap-2 text-xs">
                <IoIosPeople className="text-lg" /> team info
              </h5>
              <div className="my-6">
              ...
              <div>
                <div className="my-6">
                  ...
                  <div className="flex gap-3 items-center py-2">
                    <img
                      src={profile_pic}
                      className="w-8 border border-[#2D303A] rounded-full"
                    />
                    <span className="text-[#E3E2E7] font-semibold text-lg  ">
                      Marcus Thorne{" "}
                      <span className="text-[#C4C6D0] text-xs font-normal<HiOutlineRocketLaunch /><HiOutlineRocketLaunch />">
                        (SVP Platform)
                      </span>
                    </span>
                  </div>
            ...
            <div className="bg-[#1E1F23] p-7 border border-[#2D303A] rounded-lg">
              ...
              <div className="flex flex-col gap-3.5">
                <div className="inline-flex flex-col border-l-2 border-l-[#D8E2FF] pl-4 mt-4">
                  ...
                  <p className="text-[#C4C6D0] text-lg">Role: Lead Architect</p>
                </div>
