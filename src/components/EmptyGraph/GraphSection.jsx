...
export default function GraphSection() {
  ...
  const wizardPath =
    workspaceId && projectId
      ? `/workspaces/${workspaceId}/projects/${projectId}/wizard`
      : "/dashboard";

  return (
    <div
      id="graph"
      className="flex flex-col gap-20 items-center justify-center w-4/5 h-full"
    >
      <div
        id="centerComp"
        className="absolute top-62 w-1/5 h-1/3 bg-[#D8E2FF]/15 blur-[80px] -z-10"
      ></div>
      ...
      <div className="flex flex-col items-center justify-center gap-10 text-center">
        <h3 className="text-4xl text-[#E3E2E7]">
          Your architecture starts here.
        </h3>
        <p className="text-md leading-7 max-w-[45ch] font-light ">
          Begin mapping your system&apos;s infrastructure to unlock real-time
          telemetry visualization, automated impact analysis, and workspace-wide
          tracing.
        </p>
        <div className="flex gap-3">
          ...
          <button
            type="button"
            className="bg-transparent border border-(--border) p-5 rounded-xl text-sm flex items-center max-w-[25ch] hover:bg-(--border)/30 hover:text-white transition-all ease-in-out duration-200 cursor-pointer"
          >
